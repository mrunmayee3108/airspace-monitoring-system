...
<div class="hero">
    ...
    <div style="position:relative; z-index:1;">
        ...
        <div class="hero-title">
            AI <span>Airspace</span><br>Monitoring System
        </div>
        <div class="hero-sub">
            Advanced real-time surveillance and classification of airspace activity. 
            Detect anomalies, track trajectories, and respond to threats instantly.
        </div>
...
with col2:
    classify_btn = st.button("nav_classify", key="nav_classify")
with col3:
...
if classify_btn:
    st.switch_page("pages/2_Object_Classification.py")
if traj_btn:
